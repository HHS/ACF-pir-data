...
-- 	Optionally: View
-- Examples: 
-- 	CALL pir_data.genDifference('-', '4fbac59c868a7255a0acb42bd6e2ec54', 'TotalCumulativeEnrollment', '0addede781364f83866353b43a90fe34', 'PregnantWomen', 'ChildEnrollment', NULL);
-- 	CALL pir_data.genDifference('-', '4fbac59c868a7255a0acb42bd6e2ec54', 'TotalCumulativeEnrollment', '0addede781364f83866353b43a90fe34', 'PregnantWomen', 'ChildEnrollment', 'child_enrollment_v');
-- =============================================
...
BEGIN
	...
	IF (view_name IS NOT NULL) THEN
		SET @construct_query = CONCAT(
			'CREATE OR REPLACE VIEW ', view_name, ' AS ', @construct_query
        );
    END IF;
